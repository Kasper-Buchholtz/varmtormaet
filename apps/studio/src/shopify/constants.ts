...
// This is the ID in your Shopify admin URL (e.g. 'my-store-name' in https://admin.shopify.com/store/<your-shopify-store-id>).
...
export const SHOPIFY_STORE_ID = 'q1tppg-py'
